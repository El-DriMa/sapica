...
namespace sapica_backend.Migrations
{
    ...
    [Migration("20250224173450_EventReviewQuestionsAdded")]
    partial class EventReviewQuestionsAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sapica_backend.Data.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("sapica_backend.Data.Models.Questions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("sapica_backend.Data.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("sapica_backend.Data.Models.Questions", b =>
                {
                    b.HasOne("sapica_backend.Data.Models.Admin", "Admin")
                        .WithMany()
